...
DATASETS = {
    ...
    "random-s-128-euclidean": lambda out_fn: random_float(out_fn, 128, 1010000, 100, "euclidean"),
    "random-s-1024-euclidean": lambda out_fn: random_float(out_fn, 1024, 1010000, 100, "euclidean"),
    "random-s-1536-euclidean": lambda out_fn: random_float(out_fn, 1536, 1010000, 100, "euclidean"),
    ...
    "random-s-768-euclidean": lambda out_fn: random_float(out_fn, 768, 1010000, 100, "euclidean"),
    "random-s-786-euclidean": lambda out_fn: random_float(out_fn, 786, 1010000, 100, "euclidean"),
    "random-s-512-euclidean": lambda out_fn: random_float(out_fn, 512, 1010000, 100, "euclidean"),
    "random-s-256-euclidean": lambda out_fn: random_float(out_fn, 256, 1010000, 100, "euclidean"),
    "random-s-128-40m-euclidean": lambda out_fn: random_float(out_fn, 128, 47254554, 100, "euclidean"),
    "random-s-128-10m-euclidean": lambda out_fn: random_float(out_fn, 128, 10010000, 100, "euclidean"),
    "random-s-512-13m-euclidean": lambda out_fn: random_float(out_fn, 512, 13226188, 100, "euclidean"),
    "random-s-768-9m-euclidean": lambda out_fn: random_float(out_fn, 768, 8993808, 100, "euclidean"),
    "random-s-1536-4m-euclidean": lambda out_fn: random_float(out_fn, 1536, 4588678, 100, "euclidean"),
    ...
    "random-s-512-10m-euclidean": lambda out_fn: random_float(out_fn, 512, 10010000, 100, "euclidean"),
    "random-s-768-10m-euclidean": lambda out_fn: random_float(out_fn, 768, 10010000, 100, "euclidean"),
    "random-s-1536-10m-euclidean": lambda out_fn: random_float(out_fn, 1536, 10010000, 100, "euclidean"),
    "random-s-1536-3.5m-euclidean": lambda out_fn: random_float(out_fn, 1536, 3510000, 100, "euclidean"),
    "random-s-512-9.8m-euclidean": lambda out_fn: random_float(out_fn, 512, 9810000, 100, "euclidean"),
    "random-s-768-6.7m-euclidean": lambda out_fn: random_float(out_fn, 512, 6710000, 100, "euclidean"),
